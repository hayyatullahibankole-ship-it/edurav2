    ...
    <AkboyLayout title="Mock Exam Registration" description="Register for the AKBOY JAMB Mock Examination">
      <div className="min-h-screen bg-orange-50">
        ...
        <div className="max-w-2xl mx-auto space-y-6 py-8 px-4">
          ...
          {/* Countdown Timer */}
          {!isExpired ? (
            <Card className="border-0 shadow-lg bg-orange-500 text-white overflow-hidden">
              <CardContent className="py-5 px-6">
                ...
                <p className="text-center text-xs mt-3 opacity-90">Deadline: April 10, 2026 at 11:59 PM</p>
              </CardContent>
            </Card>
          ) : (
                ...
                <Card className="shadow-lg border-0 bg-white/80 backdrop-blur">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="text-center">
                      <a href="/contact" className="inline-flex items-center gap-2 text-sm text-orange-600 font-semibold hover:underline">
