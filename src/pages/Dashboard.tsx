...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={`relative overflow-hidden bg-gradient-to-br from-primary via-secondary to-accent animate-gradient-shift bg-[length:200%_200%] ${isMobile ? 'rounded-b-[3rem]' : ''}`}>
